...
2. **`U-12`** ⛔ — Modo oscuro, revertido a pedido de LS (14 de julio) — ver detalle abajo
...
| **A-2** | Sin paginación por cursor en `ReporteRango` | `ReporteAsistencias/ReporteRango.jsx` | ✅ Cerrado — **ver `U-14`**: la implementación original de este cierre tenía un bug real (cursor `id` sobre una columna UUID), corregido el 14 de julio |
