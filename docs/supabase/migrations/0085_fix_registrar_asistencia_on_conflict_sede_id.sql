-- Migration: 0085_fix_registrar_asistencia_on_conflict_sede_id
-- Fecha: 2026-08-10
--
-- Renumerada de 0082 a 0085 (10 ago, auditoría de estrés operacional):
-- el prefijo 0082 ya lo usaba 0082_sec35_36_unique_sede_y_trimestres_privado.sql
-- (aplicada un día antes, 9 ago, y ya referenciada por número en
-- docs/AUDITORIA_INDICE.md § SEC-35/36) — colisión de numeración entre
-- dos sesiones paralelas. Contenido sin cambios, ya aplicado en
-- producción bajo el nombre viejo (ver nota más abajo); esta renumeración
-- es solo para que el archivo en el repo quede sin colisión de ahora en
-- adelante.
--
