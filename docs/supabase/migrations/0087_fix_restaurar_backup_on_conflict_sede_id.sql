-- Migration: 0087_fix_restaurar_backup_on_conflict_sede_id
-- Fecha: 2026-08-10
--
-- Renumerada de 0083 a 0087 (10 ago, auditoría de estrés operacional):
-- el prefijo 0083 ya lo usaba 0083_arch_autovacuum_tablas_rate_limit.sql
-- (aplicada el 9 ago, ya referenciada por número en
-- docs/AUDITORIA_INDICE.md § ARCH-40) — colisión de numeración entre dos
-- sesiones paralelas. Contenido sin cambios, ya aplicado en producción
-- bajo el nombre viejo.
--
