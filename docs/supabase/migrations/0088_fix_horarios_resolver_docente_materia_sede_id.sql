-- Migration: 0088_fix_horarios_resolver_docente_materia_sede_id
-- Fecha: 2026-08-10
--
-- Renumerada de 0084 a 0088 (10 ago, auditoría de estrés operacional):
-- el prefijo 0084 ya lo usaba 0084_estad1_reporte_estadisticas_academicas.sql
-- (referenciada en docs/AUDITORIA_INDICE.md) — colisión de numeración
-- entre dos sesiones paralelas. Contenido sin cambios, ya aplicado en
