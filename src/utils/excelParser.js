...
// Fix SEC-14 (auditoría 5 de julio, complemento tras actualizar xlsx a 0.20.3):
...
export async function parseExcelFile(fileOrWorkbook, { lapso = null, selectedPrograma = "todos", catalogoDocentes = [] } = {}) {
  ...
  // Fix SEC-14: cortar antes de procesar si el workbook excede los límites
  ...
  for (const sheetName of workbook.SheetNames) {
    ...
    // Fix SEC-14: cortar antes de procesar si una hoja excede el límite de filas.
