    ...
    <div style={{ padding: 20 }}>
      ...
      <div style={S.card}>
        <div style={{ padding: "14px 20px", borderBottom: "1px solid #E5E7EB", background: "#F9FAFB" }}>
          ...
          <div style={{ fontSize: 13, color: "#6B7280", marginTop: 2, fontWeight: 500 }}>PNF en Informática · {selectedDay.charAt(0)+selectedDay.slice(1).toLowerCase()} · Turno: {turno === "DIURNO" ? "Diurno (7:30AM – 12:00PM)" : "Vespertino (1:00PM – 5:30PM)"} · Lapso {lapsoActual}</div>
        </div>
